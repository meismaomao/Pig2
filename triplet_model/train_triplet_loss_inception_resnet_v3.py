	...
	with tf.Graph(). as_default():
		...
		with tf.name_scope('loss'):
			...
			with tf.name_scope('total_loss'):
				total_loss = softmax_loss + 0.5 * center_loss + regularization_losses
		...
		with tf.Session() as sess:
			train_write = tf.summary.FileWriter('/home/lenovo/yql/pig_data/triplet_model/logs_tensorboard5/',
			                                    sess.graph)
			...
			for step in range(ITERATION):
				...
				if step % 500 == 0:
					Saver.save(sess, '/home/lenovo/yql/pig_data/triplet_model/logs_tensorboard5/')
