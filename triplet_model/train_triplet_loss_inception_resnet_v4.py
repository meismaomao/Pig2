...
def main(argv=None):
	...
	with tf.Graph(). as_default():
		...
		with tf.Session() as sess:
			train_write = tf.summary.FileWriter('/home/lenovo/yql/pig_data/triplet_model/logs_tensorboard6/',
			                                    sess.graph)
			...
			for step in range(ITERATION):
				...
				if step % 500 == 0:
					Saver.save(sess, '/home/lenovo/yql/pig_data/triplet_model/logs_tensorboard6/')
